  ...
  return (
    <div className="product-details-page">
      ...
      <div className="page-container">
        <div className="single-product-google-add">
          <img
            ...
            <div className="single-product-info-sec">
              ...
              <div className="single-product-price">
                <div className="product__productInfo__productPrice mb-2">
                  ...
                  <strong className="priceValue">{singleProduct.price}</strong>
        ...
        {/* <div class="row product-detail-info">
            ...
            <div style="width:100%;border-top:1px solid silver">
                ...
                <small>
                    ...
                    I337 from Samsung. With 16 GB of memory and a 4G connection,
                    this phone stores precious photos and video and lets you upload
                    them to a cloud or social network at blinding-fast speed. With a
                    17-hour operating life from one charge, this phone allows you
                    keep in touch even on the go. With its built-in photo editor,
                    the Galaxy S4 allows you to edit photos with the touch of a
                    finger, eliminating extraneous background items. Usable with
